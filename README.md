...
- <img src="https://cdn.simpleicons.org/safari" height="14"/> [Safari MCP](https://github.com/achiya-automation/safari-mcp) - Native Safari browser automation with 80+ tools, dual-engine architecture (Extension + AppleScript), zero Chrome overhead.
